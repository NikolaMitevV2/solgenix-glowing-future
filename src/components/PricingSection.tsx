...
const PricingSection = () => {
  const plans = [{
    ...
    features: ['Free home energy audit', 'Solar potential assessment', 'Personalized system design', 'Financing options review', 'No obligation quote'],
    recommended: false,
    ...
    features: ['Premium solar panels (6kW system)', 'Professional installation', '25-year warranty', 'Smart monitoring system', 'Grid connection & permits', 'Annual maintenance check'],
    recommended: true,
    ...
    features: ['Custom system design', 'Commercial-grade equipment', 'Project management', 'Advanced monitoring & analytics', 'Maintenance & support', 'ROI optimization consulting'],
    recommended: false,
    cta: 'Contact Sales'
  }];
  return <section id="pricing" className="py-20 bg-gradient-to-br from-white to-solgenix-50">
          ...
          animationDelay: `${index * 0.1}s`
              ...
              <div className="text-center mb-8">
                ...
                <div className="text-4xl font-light mb-2">
                  {plan.price}
                  {plan.price !== 'Free' && plan.price !== 'Custom' && <span className="text-lg text-muted-foreground">/system</span>}
                </div>
              ...
              <Button className={`w-full neumorphic ${plan.recommended ? 'bg-solgenix-gradient hover:bg-solgenix-600 text-white' : 'bg-white hover:bg-solgenix-50 text-solgenix-600 border border-solgenix-200'}`} size="lg">
                {plan.cta}
              </Button>
            </div>)}
        </div>
