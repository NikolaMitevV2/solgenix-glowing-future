  ...
  return (
    <>
      ...
      >
        ...
        {/* Mobile Menu Panel */}
        <div
          className={`absolute top-0 right-0 h-full w-80 bg-white/95 backdrop-blur-lg border-l border-white/20 transform transition-transform duration-300 ${
