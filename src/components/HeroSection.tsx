...
const HeroSection = () => {
  ...
  return <section id="hero" className="min-h-screen relative overflow-hidden bg-white">
      {/* Decorative Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="space-y-6">
              ...
              <p className="text-xl lg:text-2xl max-w-2xl text-gray-800">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="neumorphic text-lg px-8 py-4 bg-solgenix-gradient hover:bg-solgenix-600 text-darkslategray border-0" onClick={() => scrollToSection('#pricing')}>
            ...
            <div className="flex items-center space-x-8 pt-8">
              <div className="text-center">
                <div className="text-3xl font-semibold text-solgenix-600">500+</div>
                <div className="text-sm text-muted-foreground bg-slate-50">Installations</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-semibold text-solgenix-600">98%</div>
                <div className="text-sm text-muted-foreground">Satisfaction</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-semibold text-solgenix-600">25yr</div>
          ...
          <div className="relative animate-fade-in-up">
            <div className="relative z-10">
              <img src="/lovable-uploads/e0e8a5be-8bfc-425f-b104-04ae1977f1c2.png" alt="Solgenix Logo" className="w-full h-auto rounded-2xl shadow-2xl glassmorphic" />
            </div>
            {/* Floating Elements */}
