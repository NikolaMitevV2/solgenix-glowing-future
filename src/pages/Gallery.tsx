...
const Gallery = () => {
  const projects = [
    ...
    },
    {
      id: 4,
      image:
        "https://images.unsplash.com/photo-1611365892117-00ac5ef43c90?w=600&h=400&fit=crop",
      location: "Denver, CO",
    ...
    },
    {
      id: 6,
      image:
        "https://images.unsplash.com/photo-1624397640148-949b1732bb0a?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      location: "Miami, FL",
    ...
    },
    {
      id: 8,
      image:
        "https://images.unsplash.com/photo-1473800447596-01729482b8eb?w=600&h=400&fit=crop",
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="text-center mb-16">
            <h1 className="text-5xl lg:text-6xl font-light tracking-tight text-darkslategray mb-6">
              Project{" "}
              <span className="bg-solgenix-gradient bg-clip-text text-transparent">
                Gallery
              </span>
            </h1>
            <p className="text-xl text-darkslategray max-w-2xl mx-auto">
              Explore our successful solar installations across the country and
